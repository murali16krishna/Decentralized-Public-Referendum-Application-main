            ...
            <div className="container-main">
              ...
              <div className="container-item">
                <form>
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      Mobile Number <span style={{ color: "tomato" }}>*</span>
                      <input
                        className={"input-r"}
                        type="number"
                        placeholder="ex. 4563780987"
                  ...
                  <p className="note">
                    ...
                    <br /> Enter your Full Name and Mobile Number as per your official records
                  </p>
                  <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <button
                      ...
                      style={{ opacity: this.state.voterPhone.length !== 10 ? 0.5 : 1 }}
                    >
