      ...
      <>
        {voter.isVerified ? (
          <div className="container-list success">
            <p style={{ margin: "7px 0px" }}>Voter Address: {voter.address}</p>
            <table>
              <tr>
                <th>Name</th>
                <th>Phone</th>
              ...
              <tr>
                <td>{voter.name}</td>
                <td>{voter.phone}</td>
                <td>{voter.hasVoted ? "Cast Vote" : "Didn't Cast Vote"}</td>
              </tr>
            </table>
          </div>
        ) : null}
        ...
        >
          <table>
            ...
            <tr>
              <th>Verified</th>
              <td>{voter.isVerified ? "Approved by Admin" : "Not yet Approved by Admin"}</td>
            </tr>
            <tr>
              <th>Registered</th>
